...
require_config 'CONFIG_SYSVIPC=y'
require_config 'CONFIG_POSIX_MQUEUE=y'
require_config 'CONFIG_CGROUP_DEVICE=y'
require_config 'CONFIG_MEMCG=y'
require_config 'CONFIG_UTS_NS=y'
require_config 'CONFIG_USER_NS=y'
require_config 'CONFIG_PID_NS=y'
require_config 'CONFIG_IPC_NS=y'
require_config 'CONFIG_NET_NS=y'
require_config 'CONFIG_CGROUP_NET_PRIO=y'
require_config 'CONFIG_DEVTMPFS=y'
require_config 'CONFIG_VETH=y'
require_config 'CONFIG_OVERLAY_FS=y'
require_config 'CONFIG_DEVPTS_MULTIPLE_INSTANCES=y'
require_config 'CONFIG_NETFILTER_XT_MATCH_ADDRTYPE=y'
require_config 'CONFIG_NETFILTER_XT_MATCH_QTAGUID=y'
require_config '# CONFIG_NETFILTER_XT_MATCH_OWNER is not set'
...
require_config 'CONFIG_NETFILTER_XT_MATCH_RECENT=y'
require_config 'CONFIG_NETFILTER_NETLINK_QUEUE=y'
require_config 'CONFIG_NETFILTER_NETLINK_LOG=y'
require_config 'CONFIG_NETFILTER_XT_TARGET_NFLOG=y'
require_config 'CONFIG_IP6_NF_IPTABLES=y'
require_config 'CONFIG_IP6_NF_TARGET_REJECT=y'
require_config 'CONFIG_ANDROID_PARANOID_NETWORK=y'
require_config 'CONFIG_BRIDGE_NETFILTER=m'
require_config 'CONFIG_IKCONFIG=y'
require_config 'CONFIG_IKCONFIG_PROC=y'
